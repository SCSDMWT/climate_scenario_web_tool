...
hazards = {
    ...
    'extreme_temp_intensity': dict(
        ...
        calculation_description_template="<p>Intensity shows the hottest temperature that is expected to be seen in {return_time} years at a global warming level of +{covariate} °C.</p>",
    ...
    'extreme_temp_frequency_change': dict(
        ...
        calculation_description_template="<p>Change in Frequency shows how many times more frequent the hottest temperature of {intensity} °C is expected to be seen at a global temperature anomaly of +{covariate} °C compared to a global temperature anomaly +{covariate_comp} °C.</p>",
        arg_labels=['Hottest temperature (in °C):', '', ''],
    ...
    'sustained_3day_Tmin_intensity': dict(
        ...
        calculation_description_template="<p>Intensity shows the highest 3-day sustained haet that is expected to be seen in {return_time} years at a global warming level of +{covariate} °C.</p>",
        arg_labels=['', 'Set the return time (in years) to visualise the 1-in-# year extreme:'],
        arg_names=['covariate', 'return_time'],
        arg_types=dict(covariate=float, return_time=int),
        args=[
    ...
    'sustained_3day_Tmin_frequency_change': dict(
        ...
        calculation_description_template="<p>Change in Frequency shows how many times more frequent the highest 3-day sustained heat of {intensity} °C is expected to be seen at a global temperature anomaly of +{covariate} °C compared to a global temperature anomaly +{covariate_comp} °C.</p>",
        arg_labels=['Highest 3-day sustained heat (in °C):', '', ''],
        arg_names=['intensity', 'covariate_comp', 'covariate'],
        arg_types=dict(intensity=int, covariate=float, covariate_comp=float),
        args=[
    ...
    'extreme_1day_precip_intensity': dict(
        ...
        calculation_description_template="<p>Intensity shows the highest 1-day rainfall that is expected to be seen in {return_time} years at a global warming level of +{covariate} °C.</p>",
        arg_labels=['', 'Set the return time (in years) to visualise the 1-in-# year extreme:'],
        arg_names=['covariate', 'return_time'],
        arg_types=dict(covariate=float, return_time=int),
        args=[
    ...
    'extreme_1day_precip_frequency_change': dict(
        ...
        calculation_description_template="<p>Change in Frequency shows how many times more frequent the highest 1-day rainfall of {intensity} mm is expected to be seen at a global temperature anomaly of +{covariate} °C compared to a global temperature anomaly +{covariate_comp} °C.</p>",
        arg_labels=['Highest 1-day rainfall (in mm):', '', ''],
        arg_names=['intensity', 'covariate_comp', 'covariate'],
        arg_types=dict(intensity=int, covariate=float, covariate_comp=float),
        args=[
    ...
    'extreme_3day_precip_intensity': dict(
        ...
        calculation_description_template="<p>Intensity shows the highest 3-day rainfall that is expected to be seen in {return_time} years at a global warming level of +{covariate} °C.</p>",
        arg_labels=['', 'Set the return time (in years) to visualise the 1-in-# year extreme:'],
        arg_names=['covariate', 'return_time'],
        arg_types=dict(covariate=float, return_time=int),
        args=[
    ...
    'extreme_3day_precip_frequency_change': dict(
        ...
        calculation_description_template="<p>Change in Frequency shows how many times more frequent the highest 3-day rainfall of {intensity} mm is expected to be seen at a global temperature anomaly of +{covariate} °C compared to a global temperature anomaly +{covariate_comp} °C.</p>",
        arg_labels=['Highest 3-day rainfall (in mm):', '', ''],
        arg_names=['intensity', 'covariate_comp', 'covariate'],
        arg_types=dict(intensity=int, covariate=float, covariate_comp=float),
        args=[
