...
def make_pooch(path=pooch.os_cache('scotclimpact')):
    ...
    return pooch.create(
        ...
        registry={
            ...
            'model_fits/obs/GEV_covaraite_fit_HadUK_max_3day_tasmin_linear_loc_log_scale_nFits_1000_parametric_False.nc': 'md5:bedbf3875439c315c25f8ae55e7f72ab',
            ...
            'model_fits/sim/GEV_covaraite_fit_UKCP18_max_3day_tasmin_linear_loc_log_scale_nFits_1000_parametric_False.nc': 'md5:70a97606dd23f97fc32f877648e186d8',
